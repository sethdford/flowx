 ...
 */
export function simulateClaudeCodeCommand(args: string[], options: CommandOptions = {}, stores: Stores = {}): { output: string } {
 ...
 */
function simulateToolCommand(subcommand: string | undefined, args: string[], options: CommandOptions): { output: string } {
  switch (subcommand) {
    case 'list':
      return {
...
export function simulateAgentCommand(subcommand: string | undefined, args: string[], options: CommandOptions): { output: string } {
...
export function simulateConfigCommand(subcommand: string | undefined, args: string[], options: CommandOptions): { output: string } {
  switch (subcommand) {
    case 'show':
...
export function simulateMemoryCommand(subcommand: string | undefined, args: string[], options: CommandOptions, memoryStore?: Map<string, any>): { output: string } {
...
export function simulateTaskCommand(subcommand: string | undefined, args: string[], options: CommandOptions): { output: string } {
...
export function simulateSwarmCommand(subcommand: string | undefined, args: string[], options: CommandOptions): { output: string } {
...
export function simulateSparcCommand(subcommand: string | undefined, args: string[], options: CommandOptions): { output: string } {
...
export function simulateWorkflowCommand(subcommand: string | undefined, args: string[], options: CommandOptions, workflowStore?: Map<string, any>): { output: string } {
  ...
  switch (subcommand) {
    ...
    case 'status':
      ...
      // For invalid execution IDs, throw error
    ...
    case 'template':
      ...
      if (templateAction === 'show' && templateName === 'non-existent-template') {
