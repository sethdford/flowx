...
import { CircularBuffer } from "../../../../src/swarm/optimizations/circular-buffer.js";
import { TTLMap } from "../../../../src/swarm/optimizations/ttl-map.js";
import { ClaudeConnectionPool } from "../../../../src/swarm/optimizations/connection-pool.js";
import { AsyncFileManager } from "../../../../src/swarm/optimizations/async-file-manager.js";
import { OptimizedExecutor } from "../../../../src/swarm/optimizations/optimized-executor.js";
...
describe('Swarm Optimizations', () => {
  ...
  describe('OptimizedExecutor', () => {
    ...
    it('should execute tasks successfully', async () => {
      ...
      expect(mockResult.metadata.taskId).toBe(task.id.id);
      expect(mockResult.metadata.agentId).toBe(agentId.id);
    });
    
    it('should cache results when enabled', async () => {
      const task: TaskDefinition = {
        id: { id: generateId('task'), swarmId: 'test-swarm', sequence: 1, priority: 3 },
        name: 'Cached task',
