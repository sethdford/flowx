...
# FlowX Swarm Coordination (Batchtools Optimized)
...
npx flowx swarm "your complex task" --strategy <type> [options]

# Batch swarm operations
npx flowx swarm batch --tasks "frontend:dev,backend:dev,database:architect" --parallel
```

## Parallel Strategy Execution
```bash
# Execute multiple strategies concurrently
npx flowx swarm multi-strategy --config '{
...
npx flowx swarm batch-dev --services '{
...
npx flowx swarm batch-research --topics '{
...
npx flowx swarm batch-test --suites '{
...
npx flowx swarm pipeline --config '{
  "stages": [
...
npx flowx swarm analyze-pipeline --stages '{
...
npx flowx swarm deploy-multi --regions '{
...
npx flowx swarm federated-train --nodes 20 --parallel --aggregate-method "secure"
```
...
npx flowx swarm monitor-batch --metrics '{
...
npx flowx swarm auto-manage --rules '{
...
npx flowx swarm distribute --algorithm "weighted" --factors '{
  "agent-capacity": 0.4,
  "task-complexity": 0.3,
  "priority": 0.3
}'
...
npx flowx swarm batch-execute --resilient '{
...
npx flowx swarm optimize-network --compression "gzip" --batching 100 --keepalive
```
...
npx flowx swarm full-stack --project "e-commerce" --parallel-components '{
...
npx flowx swarm data-pipeline --config '{
...
npx flowx swarm security-audit --parallel-scans '{
